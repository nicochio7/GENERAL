...
namespace Practica01.Utilidades
{
    public class DataHelper
    {
        ...
        public DataHelper()
        {
            var _strCnn = new SqlConnection(Properties.Resources.StrCnn);
        }
        ...
        public DataTable ExecuteSPQuery(string sp, List<ParametrosSQL>? p)
        {
            DataTable dt = new DataTable();
        ...
        public int ExecuteSPDML(string sp, List<ParametrosSQL>? parametros)
        {
            int rows;
            try
            {
